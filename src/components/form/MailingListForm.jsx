...
} from "@/redux/api/mailinglist";
import { toast } from "sonner";

const MailingListForm = ({ isOpen, onClose, mailinglist }) => {
  const initialState = {
    email: "",
    tag: "",
  };
  ...
  const [postMailingList] = usePostMailingListMutation();
  const [updateMailingList] = useUpdateMailingListMutation();
